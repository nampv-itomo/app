...
const SongDetail = ({ selectedSongId = -1, defaultSong, selectSong, songs }) => {
  const songData = () => {
    if (selectedSongId >= 0) {
      return (
        <>
          ...
          <div className="album-img">
            <img src={songs[selectedSongId].links.images[1].url} alt={songs[selectedSongId].name} />
          </div>
          <div className="artist-img">
            <img src={songs[selectedSongId].links.images[0].url} alt={songs[selectedSongId].author} />
